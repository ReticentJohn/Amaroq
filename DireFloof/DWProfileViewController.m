    ...
    else
    {
        ...
        [[MSUserStore sharedStore] unfollowUserWithId:self.account._id withCompletion:^(BOOL success, NSError *error) {
            ...
            else
            {
                ...
                UIAlertController *alertController = [UIAlertController alertControllerWithTitle:NSLocalizedString(@"Error", @"Error") message:[NSString stringWithFormat:@"%@ %@", NSLocalizedString(@"Failed to unfollow user with error:", @"Failed to unfollow user with error:"), error.localizedFailureReason] preferredStyle:UIAlertControllerStyleAlert];
        ...
        [optionController addAction:[UIAlertAction actionWithTitle:self.muting ? NSLocalizedString(@"Unmute", @"Unmute") : NSLocalizedString(@"Mute", @"Mute") style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
            ...
            else
            {
                [[MSUserStore sharedStore] unmuteUserWithId:self.account._id withCompletion:^(BOOL success, NSError *error) {
                    ...
                    {
                        UIAlertController *alertController = [UIAlertController alertControllerWithTitle:NSLocalizedString(@"Error", @"Error") message:[NSString stringWithFormat:@"%@ %@", NSLocalizedString(@"Failed to unmute user with error:", @"Failed to unmute user with error:"), error.localizedFailureReason] preferredStyle:UIAlertControllerStyleAlert];
        ...
        [optionController addAction:[UIAlertAction actionWithTitle:self.blocking ? NSLocalizedString(@"Unblock", @"Unblock") : NSLocalizedString(@"Block", @"Block") style:UIAlertActionStyleDestructive handler:^(UIAlertAction * _Nonnull action) {
            ...
            if (!self.blocking) {
                [[MSUserStore sharedStore] blockUserWithId:self.account._id withCompletion:^(BOOL success, NSError *error) {
                    ...
                    {
                        UIAlertController *alertController = [UIAlertController alertControllerWithTitle:NSLocalizedString(@"Error", @"Error") message:[NSString stringWithFormat:@"%@ %@", NSLocalizedString(@"Failed to block user with error:", @"Failed to block user with error:"), error.localizedFailureReason] preferredStyle:UIAlertControllerStyleAlert];
            ...
            else
            {
                [[MSUserStore sharedStore] unblockUserWithId:self.account._id withCompletion:^(BOOL success, NSError *error) {
                    ...
                    {
                        UIAlertController *alertController = [UIAlertController alertControllerWithTitle:NSLocalizedString(@"Error", @"Error") message:[NSString stringWithFormat:@"%@ %@", NSLocalizedString(@"Failed to unblock user with error:", @"Failed to unblock user with error:"), error.localizedFailureReason] preferredStyle:UIAlertControllerStyleAlert];
